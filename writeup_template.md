...
whne the Code run the result can be seen in `LaneLineDetection.ipynb` notebook. Neccesary explanations can seen on cell descriptions.
...
![undist](sampleLaneDetection.png)
